<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="被回复用户id，" prop="repliedUserId">
        <el-input
          v-model="queryParams.repliedUserId"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:dynamicComment:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:dynamicComment:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:dynamicComment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:dynamicComment:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="dynamicCommentList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键id" align="center" prop="id" v-if="false"/>
      <el-table-column label="动态评论内容" align="center" prop="comment" />
      ...
      <el-table-column label="被回复用户id，" align="center" prop="repliedUserId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="动态评论内容" prop="comment">
        ...
        <el-form-item label="被回复用户id，" prop="repliedUserId">
          <el-input v-model="form.repliedUserId" placeholder="请输入被回复用户id，" />
        </el-form-item>
      </el-form>
...
<script>
import { listDynamicComment, getDynamicComment, delDynamicComment, addDynamicComment, updateDynamicComment, exportDynamicComment } from "@/api/system/dynamicComment";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        comment: [
          { required: true, message: "动态评论内容不能为空", trigger: "blur" }
        ],
        rId: [
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listDynamicComment(this.queryParams).then(response => {
          this.dynamicCommentList = response.rows;
      ...
      handleUpdate(row) {
        ...
        getDynamicComment(id).then(response => {
          this.loading = false;
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            ...
            if (this.form.id != null) {
              updateDynamicComment(this.form).then(response => {
              ...
              addDynamicComment(this.form).then(response => {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有动态评论数据项?', "警告", {
          ...
          return exportDynamicComment(queryParams);
        }).then(response => {
