<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="客服图片" prop="imgUrl">
        <el-input
    ...
    <el-table v-loading="loading" :data="centerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客服图片" align="center" prop="id" v-if="false"/>
      <el-table-column label="手机号" align="center" prop="phone" />
      <el-table-column label="微信号" align="center" prop="wxcode" />
      <el-table-column label="客服图片" align="center" prop="imgUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="微信号" prop="wxcode">
          <el-input v-model="form.wxcode" placeholder="请输入微信号" />
        </el-form-item>
        <el-form-item label="客服图片" prop="imgUrl">
          <el-input v-model="form.imgUrl" placeholder="请输入客服图片" />
        </el-form-item>
      </el-form>
...
<script>
import { listCenter, getCenter, delCenter, addCenter, updateCenter, exportCenter } from "@/api/system/center";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除客服编号为"' + ids + '"的数据项?', "警告", {
