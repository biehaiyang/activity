<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="访问链接" prop="clickUrl">
        <el-input
    ...
    <el-table v-loading="loading" :data="bannerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="顺序" align="center" prop="id" v-if="false"/>
      <el-table-column label="广告名称" align="center" prop="name" />
      <el-table-column label="图片链接" align="center" prop="imgUrl" />
      <el-table-column label="访问链接" align="center" prop="clickUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="访问链接" prop="clickUrl">
          <el-input v-model="form.clickUrl" placeholder="请输入访问链接" />
        </el-form-item>
        <el-form-item label="顺序" prop="sort">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除广告图片编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有广告图片数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
